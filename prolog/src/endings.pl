...
forest_cave_ending_weakened :-
    write('The weird ring started to glowing giving you the power to destroy all of the cult places.'), n1,
    write('Armed with every piece of the puzzle, the detective confronts the heart of the sect’s power.'), n1,
    write('Having the power of ring you easly destroys the most powerful place of cult.'), n1,
    write('The city, now freed from its dark binds, is left desolate and cursed, but you walk away victorious.'), n1,
...
forest_cave_ending_killed :-
    write('The cult for long knew that you were on their tails.'), n1,
    write('Yet, as you finally grasp the full horror of the sect''s motives, you are caught in a trap, surrounded by the sect’s followers.'), n1,
    write('Expecting you the ambush you and they easily kill you.'), n1,
    write('Your journey ends here, as they are drawn into the dark embrace of the city, their fate forever tied to its haunting secrets.'),
    finish.